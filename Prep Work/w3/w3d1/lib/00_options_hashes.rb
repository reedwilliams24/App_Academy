...
def transmogrify(string, options = {})
  ...
  transformed_string = transformed_string.upcase if options[:upcase]
  transformed_string = transformed_string.reverse if options[:reverse]
  transformed_string * options[:times]
